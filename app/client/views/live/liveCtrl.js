const live = angular.module("reg");

live.controller("LiveCtrl", [
    "$scope",
    "$http",
    "$state",
            ...
            controller: ["$scope", "$element", "$attrs", "$timeout",
                function ($scope, $element, $attrs, $timeout) {
                    ...
                    $scope.stop = $scope.pause = $element[0].stop = $element[0].pause = function () {
                        const timeoutId = $scope.timeoutId;
                        $scope.clear();
                    ...
                    if ($scope.countdownattr) {
                        ...
                        $scope.$on("timer-set-countdown-seconds", (e, countdownSeconds) => {
                            if (!$scope.isRunning) {
                                $scope.clear();
                            }
                    ...
                    var tick = function () {
                        ...
                        let adjustment = $scope.millis % 1000;
