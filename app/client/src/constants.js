...
angular.module('reg')
    ...
    .constant('DASHBOARD', {
        ...
        SUBMITTED: 'Feel free to edit it at any time. However, once registration is closed, you will not be able to edit it any further.\nWe will review your application in the coming days and make a decision about your admission soon. Please make sure your information is accurate before registration is closed!',
        ...
        DECLINED: 'We\'re sorry to hear that you won\'t be able to make it to HackTX 2020! :(\nMaybe next year! We hope you see you again soon.',
    })
    .constant('TEAM',{
