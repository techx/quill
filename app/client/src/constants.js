const year = 2018;
const eventName = `BigRed//Hacks ${year}`;

angular.module("reg")
    .constant("EVENT_INFO", {
        SCHOOL_NAME_SHORT: "Cornell",
        SCHOOL_NAME_LONG: "Cornell University",
        NAME: eventName,
        YEAR: year,
    })
    .constant("DASHBOARD", {
        ...
        DECLINED: `We\'re sorry to hear that you won\'t be able to make it to ${eventName}! :(\nMaybe next year! We hope you see you again soon.`,
    })
    .constant("TEAM", {
