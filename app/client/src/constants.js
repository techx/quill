angular
  ...
  .constant("DASHBOARD", {
    ...
    INCOMPLETE:
      "If you do not complete your application before the [APP_DEADLINE]), you will not be considered for admission!",
  ...
  .constant("TEAM", {
    NO_TEAM_REG_CLOSED:
      "Unfortunately, it's too late to apply with a team.\nHowever, you can still form teams on your own before or during the event!"
  });
