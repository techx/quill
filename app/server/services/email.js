...
controller.sendAcceptanceEmail = function(email, confirmBy, callback) {
  ...
  var confirmDeadline = moment(date).format('dddd, MMMM Do YYYY, h:mm a') +
    ...
    var locals = {
      ...
      subtitle: '',
      description: 'TLDR; Check in on our <a href="https://register.hacktx.com">registration portal</a>, join our <a href="https://discord.gg/QhDHJpM">Discord channel</a>, confirm your spot if you haven’t already, look at HackTX schedule!<br><br>' +
        ...
        '<br> 💫 The biggest things you need to do right now is: 💫<br>1) Check into HackTX in the <a href="https://register.hacktx.com">registration portal</a> <br> 2) Join our <a href="https://discord.gg/QhDHJpM">Discord channel</a> for announcements and updates.<br><br>' +
