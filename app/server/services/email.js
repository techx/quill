...
controller.sendAcceptanceEmail = function(email, confirmBy, callback) {
  ...
  var confirmDeadline = moment(date).format('dddd, MMMM Do YYYY, h:mm a') +
    ...
    var locals = {
      ...
      subtitle: '',
      description: 'TLDR; Check in on our registration portal, join our Discord channel, confirm your spot if you haven’t already, look at HackTX schedule!<br><br>' +
        'Congratulations on being accepted to HackTX! We are so excited to have you join us this upcoming weekend. As we prepare for the hackathon, we want to provide you with some more information about what to expect at HackTX 2020. This email will be lengthy but try to skim through to get the important info!' +
        '<br> 💫 The biggest things you need to do right now is: 💫<br>1) Check into HackTX in the registration portal <br> 2) Join our Discord channel for announcements and updates.<br>' +
        'You will need to have confirmed your spot in your acceptance email to verify your account. In order to verify your account on discord, you have to click the ‘Check into HackTX’ button in the registration portal, and that will give you a verify command to paste into discord. Please be sure both things are done before the event! <br>' +
        'Additionally, please mark yourself as going on our Facebook Event page for updates and reminders!<br>' + 
        'Tentative Schedule (All Times in CT):<br>Friday<br> 10 - 10:30 PM: Opening Ceremony<br>10:30 PM - 12 AM: Team Formation 1<br><br>' +
        ...
        '<br>Sunday1 - 2 AM: Smash Tournament<br>2 - 3 AM: League of Legends Tournament<br>9 - 10 AM: Pitching Workshop<br>11 AM SUBMISSIONS ARE DUE<br>11:30 AM - 1 PM: Judging<br>1 - 2 PM: Project Fair<br>2 - 3 PM: Closing Ceremony<br>' +
        'What should I do before I come to the event?<br>Brainstorm some ideas, get a team together! Look at our Ultimate Hackathon Starting Guide if you want more guidance. Also, make sure to make a discord account, as that will be our primary means of communication for everything HackTX.<br><br>' +
